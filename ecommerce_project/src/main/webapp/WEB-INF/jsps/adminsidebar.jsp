	...
	<nav class="navbar bg-light navbar-light">
		...
		<div class="navbar-nav w-100">
			...
			<a href="widget" class="nav-item nav-link"><i
				...
				href="adminorder" class="nav-item nav-link"><i
				class="fa fa-th me-2"></i>Order</a> <a href="form"
				class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Forms</a>
			<a href="table" class="nav-item nav-link"><i
				class="fa fa-table me-2"></i>Tables</a> <a href="chart"
